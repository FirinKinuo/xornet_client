<template>
  <div class="bg-black flexcol gap-4 p-4 w-min">
    ...
    <base-tooltip :text="copied ? 'Copied!' : 'Click to copy!'" placement="bottom">
      <div
        class="copyButton"
        @click="copy('curl https://raw.githubusercontent.com/FirinKinuo/xornet-reporter/main/scripts/install.sh | sudo bash')"
      >
        <p
          class="text-left"
        >
          <strong class="text-primary-400">$ </strong> curl https://raw.githubusercontent.com/FirinKinuo/xornet-reporter/main/scripts/install.sh | sudo bash
        </p>
      </div>
    </base-tooltip>
    ...
    <base-tooltip :text="copied ? 'Copied!' : 'Click to copy!'" placement="bottom">
      <div
        class="copyButton"
        @click="copy('Set-ExecutionPolicy RemoteSigned -Scope CurrentUser \niwr -useb get.scoop.sh | iex \nscoop install https://raw.githubusercontent.com/FirinKinuo/xornet-reporter/main/scripts/xornet-reporter.json')"
      >
        <p
          class="text-left"
        >
          ...
          <strong class="text-primary-400">> </strong> scoop install "https://raw.githubusercontent.com/FirinKinuo/xornet-reporter/main/scripts/xornet-reporter.json"
        </p>
      </div>
    </base-tooltip>
    ...
    <div class="flex justify-between">
      ...
      <base-link href="https://github.com/FirinKinuo/xornet-reporter#-installation">
        What to do?
      </base-link>
    </div>
  </div>
